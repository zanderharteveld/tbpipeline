...
python /work/lpdi/users/hartevel/bin/topobuilder/topobuilder/base_plugins/imaster/imaster.py -case current.yml -master step02/_${SLURM_ARRAY_TASK_ID}.master -present B1E.B2E.A3E.A4E.B3E.A2E.A1E -out step02/_${SLURM_ARRAY_TASK_ID}.geo
fi
