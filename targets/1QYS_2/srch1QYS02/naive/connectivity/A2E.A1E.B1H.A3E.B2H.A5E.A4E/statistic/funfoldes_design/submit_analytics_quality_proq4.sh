...
python /work/lpdi/users/hartevel/bin/topobuilder/topobuilder/base_plugins/statistics/calc_proq4.py -p ${SLURM_ARRAY_TASK_ID} -f srch1QYS02/naive/connectivity/A2E.A1E.B1H.A3E.B2H.A5E.A4E/statistic/funfoldes_design/_pdb_files/${SLURM_ARRAY_TASK_ID} -o srch1QYS02/naive/connectivity/A2E.A1E.B1H.A3E.B2H.A5E.A4E/statistic/funfoldes_design
