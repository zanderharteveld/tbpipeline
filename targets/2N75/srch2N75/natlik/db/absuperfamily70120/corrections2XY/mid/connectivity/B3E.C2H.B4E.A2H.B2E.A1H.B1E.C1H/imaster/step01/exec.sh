...
python /work/lpdi/users/hartevel/bin/topobuilder/topobuilder/base_plugins/imaster/imaster.py -case current.yml -master step01/_${SLURM_ARRAY_TASK_ID}.master -present B3E.B4E.B2E.B1E -out step01/_${SLURM_ARRAY_TASK_ID}.geo
fi
