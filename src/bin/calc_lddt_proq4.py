...
def cli_parser():
    ...
    parser.add_argument('--pdb_folder', '-f', type=str, nargs='+', help="Path to folder containing the pdb files.")
    parser.add_argument('--type', '-t', type=str, nargs=1, default="naive", help="Model type. (default: naive)")
    parser.add_argument('--stage', '-s', type=str, nargs=1, default="design", help="Backbone stage. (default: design)")
    return parser
...
def main():
    ...
    # Compute and save
    d = {"type": [], "stage": [], "description": [], "lDDT": [], "classes": []}
    print("Starting iterations...")
    for pdbfile in pdb_folder:
    ...
    df = pd.DataFrame(d)
    df.to_pickle("./{}_proq4.pkl".format(type_))
